...
router.get( '/post/:id', bearerAuth, role('read'), getOnePost  );
router.post( '/post', bearerAuth, role('create'), newPost  );
router.put( '/post/:id', bearerAuth, role('update'), updatePost );
router.delete( '/post/:id', bearerAuth, role('delete'), deletePost );
